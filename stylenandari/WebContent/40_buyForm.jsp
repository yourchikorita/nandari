...
<script src="40_buyForm.js"></script>
...
<c:set var="total" value="0"/>
  <c:forEach var="cart" items="${cartLists}">
    <tr> 
    <td>
    	<img width="160" src="images/${cart.getItem_image()}" 
             class="cartimage">
    </td>
       <td width="300">
         ${cart.getItem_name()}
    ...
    <tr>
       <td colspan="4" align="right" class="b">총 금액 : 
        <span style="font-size:30px;"><fmt:formatNumber value="${total}" type="number" pattern="#,##0"/>원</span></td>
    </tr>
</table>
</div>
...
<!-- 주문자 정보 -->
<div id="buyArea">
<form name="buyForm" method="post" action="/stylenandari/buyPro.do">
<table>
   <tr> 
